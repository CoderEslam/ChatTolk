...
public class GroupsFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        reference = FirebaseDatabase.getInstance("https://myfirebasechat-7f391-default-rtdb.firebaseio.com/").getReference(REF_USERS).child(currentId);
        ...
        Query query = FirebaseDatabase.getInstance("https://myfirebasechat-7f391-default-rtdb.firebaseio.com/").getReference(REF_GROUP_MEMBERS_S + firebaseUser.getUid() + EXTRA_GROUPS_IN_BOTH);
